...
class GetHtmlTest extends TestCase
{
    ...
    public function testExecuteReturnsFailureWhenMailIsNotAvailable()
    {
        ...
        $getHtml = new GetHtml($this->storageMock);

        $result = wait($getHtml->execute($this->inputMock));
    ...
    public function testExecuteReturnsResponseWhenHtmlIsAvailable()
    {
        ...
        $this->assertInstanceOf(Success::class, $result);
        $this->assertSame('{"success":true,"payload":{"command":"html","html":"HTML"}}', (string) $result);
    }
    ...
    public function testExecuteReturnsResponseWhenHtmlIsNotAvailable()
    {
        ...
        $this->assertInstanceOf(Success::class, $result);
        $this->assertSame('{"success":true,"payload":{"command":"html","html":null}}', (string) $result);
    }
}
